...
* The lecture series is designed for young professionals and first-year students in architectural design schools. It aims to help participants understand and utilize hardware and software technologies as tools in the design process. The focus is on teaching how to use data as design materials and how to code the design process by treating data as instructions.
  ...
  * 2021 디자이너가 코딩을 왜 배워야 할까? (디자이너를 위한 컴퓨테이셔널 디자인) - https://computationaldesign.tistory.com/37
...
link: [https://brunch.co.kr/@njnamju/90](https://brunch.co.kr/@njnamju/90)  
...
Network Anlaysis - [한국어] SA 7.0 Unit 2 -  https://computationaldesign.tistory.com/19
* Korean, English
...
* [한국어 ] Digital FUTURES World Workshop Full Version -  https://computationaldesign.tistory.com/16
...
# Computational Design [Grasshopper C# Scripting]
...
* Korean 
link: https://computationaldesign.tistory.com/35, ~~English~~
...
* [Workshop]건축 애니메이션 (3ds max & AfterEffect), architectural-animation-visualization - https://computationaldesign.tistory.com/34
* Content  
  Pre-production  
  Raising questions  
  Production  

...
1.5 참조
  ...
  컴퓨테이셔널 디자인- https://namjulee.github.io/njs-lab-public/lecture?id=ggBVX5W-28c
  컴퓨테이셔널 사고 - https://namjulee.github.io/njs-lab-public/lecture?id=B7MaKoxpH8Q 
  파라메트릭 디자인 - https://namjulee.github.io/njs-lab-public/lecture?id=LVybPm_VUhs
...
* Introduction Computation for Design - [slides](https://docs.google.com/presentation/d/1Z-jSy-nD18ifqefktrEHQGW4SjpJehAqX6nfcwGcnRQ/edit#slide=id.g2e7a1a6a41f_1_30)
...
### Homework:
* Complete:   
  the installation(software and development environment)   
  the tutorial   
* Read the Chapter 01 
...
2.3 랩 (Lab)
  파이썬 기초 / 라이노 파이썬 - LAB_01_PythonBasic.ipynb
  파이썬 데이터 구조 - LAB_02_PythonBasicDataProcessing.ipynb
...
4.5 참조
	Curve - https://namjulee.github.io/njs-lab-public/lab/lab-curve-discrete-design-data/line-curve 
...
5.4 과제
	발표: 지오메트리 & 디자인 데이터 정리 요약 
  	수업 요약: 쉽게 이해하는 클래스 https://namjulee.github.io/njs-lab-public/lecture?id=lA3KWQTrToU  
...
---
# 6. OOP Programming & Data Structure and Processing 
...
7.4 과제
	Graph 구현 완성
	수업요약 - 자료구조, 그래프 / Data Structure for design , Graph 1/2 - https://namjulee.github.io/njs-lab-public/lecture?id=cUEQmPh57MU  
...
9.4 과제
	수업요약: Computational Thinking, Software 1.0 VS AI, Data-driven Thinking, Software 2.0 - https://namjulee.github.io/njs-lab-public/lecture?id=mT3T3fOd2K8  
	참조수업: 인공지능(AI, ML)을 상상, 소설, 매스컴, 영화, 비전문가를 통해 정리한 디자이너를 위한 개념 정리, 디자인 인공지능, 머신러닝 - https://namjulee.github.io/njs-lab-public/lecture?id=Bd9U-wjCLDU 
...
---
### Reference:
* https://namjulee.github.io/njs-lab-public/lab/ai-&-ml-for-designers/ai-for-design
...
13.5 참조
	Lecture 3. 캐드, 데이트의 흐름 / CAD data pipeline - https://namjulee.github.io/njs-lab-public/lecture?id=n7qvjYWHyRs 

...
function MapboxGLHousing(theDiv,zoomFactor, _pitch, navigable, data){
...
MapboxGLHousing.prototype.LoadData=function() {
...
MapboxGLHousing.prototype.DataPrcess = function() {
    var vis = this;
...
MapboxGLHousing.prototype.VisMap = function(){
    var vis = this;
    ...
    this.circle = this.theSvg
                        ...
                        .on("click", function(d){
                            console.log(d)
                            $("#maplogHosing").html("<p>type:"+ d.status +"<br>" +
                                              "address:" + d.address +"<br>" +          
                                              "zip:" + d.zip +"<br>" +                        
                                              "Price: $" + d.prices +"<br>" +        
                                              "last_sold_price: $" + d.zillow.last_sold_price +"<br>" +    
                                              "zestimate_value_change: $" + d.zillow.zestimate_value_change +"<br>" +                      
                                              "home size:" + d.zillow.home_size +"<br>" +
                                              "built year:" + d.zillow.year_built +"<br>" +     
                                              "num bedrooms:" + d.zillow.bedrooms +"<br>" +
                                              "num bathrooms:" + d.zillow.bathrooms +"<br>" +                     
                                              "lat:" + (+d.lat) +"<br>" +
                                              "long:"+ (+d.long) +"</p>");
                        });
    this.Update()           
};
MapboxGLHousing.prototype.Update = function() {
    var vis = this;

    vis.circle
        .attr("cx", function(d){
            theCoordinates = [d.long, d.lat]
...
MapboxGLHousing.prototype.Projection = function(d) {
